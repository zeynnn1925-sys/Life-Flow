...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[40rem] flex-col items-center justify-center overflow-hidden bg-canvas w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 bg-canvas blur-2xl"></div>
        <div className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-accent opacity-50 blur-[8rem]"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-accent-focus blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
